...
# Для проверки наличия пользователя в множестве используйте магический метод проверки
# на равенство пользователей.
...
class Project:
    ...
    def json_to_users(self, file_name='sem8_1/res2.json'):
